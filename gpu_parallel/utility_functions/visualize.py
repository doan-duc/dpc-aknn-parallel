...
Tự động chọn:
  - PCA 2D nếu n > 10000 (nhanh, vài giây)
  - t-SNE 2D nếu n <= 10000 (đẹp hơn, vài phút)
"""
...
def main():
    ...
    ap.add_argument("--method",   default="auto", choices=["auto","pca","tsne"],
                    help="Phuong phap giam chieu (mac dinh: auto = PCA neu n>10K)")
